                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" class="form-control form-control-sm" placeholder="Type" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
...
<script>
    $(document).ready(function () {
        ...
        $('#btn-cancel').on('click', function () {
            $('#form-room-type')[0].reset();
            $('#btn').removeClass('btn-info').addClass('btn-success').val('Simpan');
            $('#action').val('add');
            $('#btn-cancel').hide();
        });
        
        $('#form-room-type').on('submit', function (event) {
        ...
        $(document).on('click', '.delete', function () {
            ...
            $.ajax({
                url: '/admin/room-type/delete/'+room_id,
                success: function (data) {
                    if (data.success) {
                        toastr.success(data.success);
                        $('#table').DataTable().ajax.reload();
